                  ...
                  <div>
                    <form v-on:submit.prevent="newCampaign()">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" v-model="newCampaignParams.image" />
                      </div>
                      <div class="mb-3">
                      ...
                      <div class="d-grid">
                        <button class="btn btn-danger" type="submit">Create campaign</button>
                      </div>

                      <ul v-if="errors.length > 0" class="alert alert-info mt-3 mb-0">
